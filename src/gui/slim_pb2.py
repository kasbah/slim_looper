...
_SLIMMESSAGE_LOOPER = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      name='number', full_name='SlimMessage.Looper.number', index=0,
